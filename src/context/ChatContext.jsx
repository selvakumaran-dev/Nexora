...
export function ChatProvider({ children }) {
    ...
    const markAsRead = useCallback((chatId) => {
        ...
        // In a real app, we'd gather unread message IDs and send them
        // For now, we'll assume the backend handles "mark all as read" logic
        // or we just trigger the event for the last message
        const chat = chats.find(c => c._id === chatId)
        if (chat && chat.lastMessage && !chat.lastMessage.readBy?.some(r => r.userId === user?._id)) {
